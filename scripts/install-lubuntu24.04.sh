...
DISK_PATH="$STORAGE/hd/lubuntu24.04.qcow2"
DISK_SIZE="35G"
...
AUTOINSTALL_TEMPLATE="$REPO_DIR/lubuntu24.04-autoinstall.yaml"
...
AUTOINSTALL_RENDERED=$(mktemp /tmp/lubuntu24-autoinstall.XXXXX.yaml)
touch "$META_TMP"
