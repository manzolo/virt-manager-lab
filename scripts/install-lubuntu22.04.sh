...
DISK_PATH="$STORAGE/hd/lubuntu22.04.qcow2"
DISK_SIZE="30G"
...
AUTOINSTALL_TEMPLATE="$REPO_DIR/lubuntu22.04-autoinstall.yaml"
...
AUTOINSTALL_RENDERED=$(mktemp /tmp/lubuntu22-autoinstall.XXXXX.yaml)
touch "$META_TMP"
