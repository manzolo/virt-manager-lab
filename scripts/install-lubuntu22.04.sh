#!/usr/bin/env bash
# Installazione unattended Lubuntu 22.04 LTS (Jammy) — lubuntu22
...
DISK_PATH="/home/manzolo/Workspaces/qemu/storage/hd/lubuntu22.04.qcow2"
DISK_SIZE="30G"
ISO_ORIG="/home/manzolo/Workspaces/qemu/storage/Iso/Distro/ubuntu-22.04.5-live-server-amd64.iso"
ISO_AUTO="/home/manzolo/Workspaces/qemu/storage/Iso/Distro/lubuntu-22.04.5-autoinstall.iso"
AUTOINSTALL_SRC="/home/manzolo/Workspaces/qemu/virt-manager/lubuntu22.04-autoinstall.yaml"
...
echo "Preparo ISO autoinstall Lubuntu 22.04..."
rm -f "$ISO_AUTO"

GRUBCFG_TMP=$(mktemp /tmp/lubuntu22-grub.cfg.XXXXX)
META_TMP=$(mktemp /tmp/lubuntu22-meta.XXXXX)
touch "$META_TMP"
...
menuentry "Automated Lubuntu 22.04 Install" {
    set gfxpayload=keep
