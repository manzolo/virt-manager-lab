...
Base Ubuntu **24.04.4** live-server + autoinstall, metapacchetto **Budgie** installato nella fase principale di curtin (lista `packages:` del template condiviso `ubuntu-flavor22.04-autoinstall.yaml`).
