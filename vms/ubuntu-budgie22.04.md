...
| Campo | Valore |
|-------|--------|
| Nome  | ubuntu-budgie22.04 |
| UUID  | assegnato dinamicamente alla creazione |
| OS    | Ubuntu Budgie 22.04 LTS |
...
|-------------|------|-----|---------|---------|------------|
| vda (disco) | `/home/manzolo/Workspaces/qemu/storage/hd/ubuntu-budgie22.04.qcow2` | virtio | qcow2 | discard=unmap | 30G |
...
Base Ubuntu **22.04.5** live-server + autoinstall, metapacchetto **Budgie** installato nella fase principale di curtin (lista `packages:` del template condiviso `unattended/ubuntu-flavor-autoinstall.yaml`).
