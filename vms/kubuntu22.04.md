...
Base Ubuntu **22.04.5** live-server + autoinstall, metapacchetto **KDE Plasma** installato nella fase principale di curtin (lista `packages:` del template condiviso `ubuntu-flavor22.04-autoinstall.yaml`).
