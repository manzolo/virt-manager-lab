...
|-------------|------|-----|---------|---------|------------|
| vda (disco) | `/home/manzolo/Workspaces/qemu/storage/hd/kubuntu22.04.qcow2` | virtio | qcow2 | discard=unmap | 35G |
...
Base Ubuntu **22.04.5** live-server + autoinstall, metapacchetto **KDE Plasma** installato nella fase principale di curtin (lista `packages:` del template condiviso `unattended/ubuntu-flavor-autoinstall.yaml`).
