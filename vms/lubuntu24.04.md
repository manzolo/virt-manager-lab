...
|-------------|------|-----|---------|---------|------------|
| vda (disco) | `/home/manzolo/Workspaces/qemu/storage/hd/lubuntu24.04.qcow2` | virtio | qcow2 | discard=unmap | 35G |
...
Base Ubuntu **24.04.4** live-server + autoinstall, pacchetto **LXQt** installato nella fase principale di curtin (lista `packages:`).
