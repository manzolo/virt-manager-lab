...
| Campo | Valore |
|-------|--------|
| Nome  | ubuntu-budgie24.04 |
| UUID  | assegnato dinamicamente alla creazione |
| OS    | Ubuntu Budgie 24.04 LTS |
...
|-------------|------|-----|---------|---------|------------|
| vda (disco) | `/home/manzolo/Workspaces/qemu/storage/hd/ubuntu-budgie24.04.qcow2` | virtio | qcow2 | discard=unmap | 30G |
...
Base Ubuntu **24.04.4** live-server + autoinstall, metapacchetto **Budgie** installato nella fase principale di curtin (lista `packages:` del template condiviso `unattended/ubuntu-flavor-autoinstall.yaml`).
