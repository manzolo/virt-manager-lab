...
|-------------|------|-----|---------|---------|------------|
| vda (disco) | `/home/manzolo/Workspaces/qemu/storage/hd/lubuntu26.04.qcow2` | virtio | qcow2 | discard=unmap | 35G |
...
Base Ubuntu **26.04** live-server + autoinstall. Il metapacchetto **LXQt** viene installato al **primo boot** sul sistema reale (servizio `lab-desktop`), non nell'installer: su 26.04 l'unpack del desktop nell'overlayfs della live ISO causa un kernel oops (`ovl_iterate_merged`).
